...
district = st.selectbox("Selecciona el distrito de San Francisco del que deseas visualizar la criminalidad en el mapa :",district)
...
n = df['Analysis Neighborhood'].unique()
n = st.selectbox("Selecciona el vecindario del que deseas visualizar la criminalidad en el mapa :",n)
nn=df[(df['Analysis Neighborhood'] == n)]


nc=pd.DataFrame()
nc["lat"]=nn['Latitude']
nc["lon"]=nn['Longitude']
st.header("Crímenes por vecindario")
